...
public class GUI {
    ...
    public void OpenKitMenu(Player p, int slot) {
        ...
        menu.getSlot(45).setItem(createItem(Material.CHAINMAIL_BOOTS, 1, "&7ʙᴏᴏᴛꜱ"));
    ...
    public void InspectEc(Player p, UUID target, int slot) {
        ...
        if (p.hasPermission("perplayerkit.admin")) {
            ...
            menu.getSlot(52).setItem(createItem(Material.BARRIER, 1, "&cᴄʟᴇᴀʀ ᴇɴᴅᴇʀᴄʜᴇꜱᴛ", "&7● Shift click to delete enderchest"));
    ...
    public void OpenMainMenu(Player p) {
        ...
        for (int i = 9; i < 18; i++) {
            menu.getSlot(i).setItem(createItem(Material.BARREL, 1, "&3&lKit " + (i - 8), "&7● Left click to load kit", "&7● Right click to edit kit"));
        ...
        for (int i = 18; i < 27; i++) {
            if (KitManager.get().getItemStackArrayById(p.getUniqueId() + "ec" + (i - 17)) != null) {
                ...
                menu.getSlot(i).setItem(createItem(Material.STRUCTURE_VOID, 1, "&3&lEnderchest " + (i - 17), "&7● Click to create"));
        ...
        menu.getSlot(37).setItem(createItem(Material.NETHER_STAR, 1, "&aᴋɪᴛ ʀᴏᴏᴍ"));
        menu.getSlot(38).setItem(createItem(Material.BOOKSHELF, 1, "&eᴘʀᴇᴍᴀᴅᴇ ᴋɪᴛꜱ"));
        menu.getSlot(39).setItem(createItem(Material.OAK_SIGN, 1, "&aɪɴꜰᴏ", "&7● Click a kit slot to load your kit", "&7● Right click or click the book to edit", "&7● Share kits with /sharekit <slot>"));
        menu.getSlot(41).setItem(createItem(Material.REDSTONE_BLOCK, 1, "&cᴄʟᴇᴀʀ ɪɴᴠᴇɴᴛᴏʀʏ", "&7● Shift click"));
        menu.getSlot(42).setItem(createItem(Material.COMPASS, 1, "&aꜱʜᴀʀᴇ ᴋɪᴛꜱ", "&7● /sharekit <slot>"));
        menu.getSlot(43).setItem(createItem(Material.EXPERIENCE_BOTTLE, 1, "&aʀᴇᴘᴀɪʀ ɪᴛᴇᴍꜱ"));
    ...
    public void OpenKitRoom(Player p, int page) {
        ...
        menu.getSlot(45).setItem(createItem(Material.BARREL, 1, "&3ʀᴇꜰɪʟʟ"));
    ...
    public Menu ViewPublicKitMenu(Player p, String id) {
        ...
        Menu menu = ChestMenu.builder(6).title(ChatColor.GRAY + "ᴠɪᴇᴡɪɴɢ ᴘᴜʙʟɪᴄ ᴋɪᴛ " + id).redraw(true).build();
    ...
    public void OpenPublicKitMenu(Player player) {
        ...
        for (int i = 18; i < 36; i++) {
            menu.getSlot(i).setItem(ItemUtil.createItem(Material.BOOK, 1, "&7ᴍᴏʀᴇ ᴋɪᴛꜱ ᴄᴏᴍɪɴɢ ꜱᴏᴏɴ"));
        }
